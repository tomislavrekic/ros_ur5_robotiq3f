...
def find_cyl(color_img, depth_img, model_path):
    ...
    cam_pam.intrinsic_matrix = [[554.254691191187, 0.0, 320.5], [0.0, 554.254691191187, 240.5], [0.0, 0.0, 1.0]]
    cam_pam.height = 640
    cam_pam.width = 480
    ...
    #voxel_down_pcd = pcd.voxel_down_sample(voxel_size=0.01)
    p_cl, ind = outlier_cloud.remove_statistical_outlier(nb_neighbors=30, std_ratio=0.1)
